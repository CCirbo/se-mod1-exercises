RSpec.describe 'Nested Collections' do
  ...
  it 'test 17.5' do
   ...
   it 'test 18' do
    ...
    actual = three_day_forecast.keys.find {|key| key == "date"}.to_s
    expected = "date"
    expect(actual).to eq(expected)
  end
  ...
  it 'test 18.5' do
    ...
    actual = "date" if three_day_forecast.has_key?("date")

    expected = "date"
    expect(actual).to eq(expected)

      # three_day_forecast.has_key?("date") checks if the key "date" exists in the hash.
      # If the key exists, "date" is assigned to the actual variable.
      # The actual variable is compared with the expected string to ensure they match.
  end
   ...
   it 'test 19' do
    ...
    # Using the three_day_forecast variable defined above,
    # Change the high on the first day to 99
   ...
   it 'test 20' do
    ...
    three_day_forecast.replace({"time" => "12:30"}.merge(three_day_forecast))
